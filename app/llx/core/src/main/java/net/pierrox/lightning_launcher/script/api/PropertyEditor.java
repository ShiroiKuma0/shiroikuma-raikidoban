...
public class PropertyEditor {
    ...
    private final HashMap<String, Object> mBundle;
    private final ItemViewUpdate mUpdateLabelVisibility = new ItemViewUpdate() {
        @Override
    ...
    private final ItemViewUpdate mUpdateLabelColor = new ItemViewUpdate() {
        @Override
        public void update(ItemView itemView) {
    ...
    private final ItemViewUpdate mUpdateLabelFontSize = new ItemViewUpdate() {
        @Override
        public void update(ItemView itemView) {
    ...
    private final ItemViewUpdate mUpdateLabelFontStyle = new ItemViewUpdate() {
        @Override
        public void update(ItemView itemView) {
    ...
    private final ItemViewUpdate mUpdateIconVisibility = new ItemViewUpdate() {
        @Override
        public void update(ItemView itemView) {
    ...
    private final ItemViewUpdate mUpdateIconGraphics = new ItemViewUpdate() {
        @Override
        public void update(ItemView itemView) {
        ...
        for (String token : encoded_box.split(String.valueOf(Box.LIST_SEP))) {
            ...
            if (p != -1) {
                ...
                if (c0 == 'c') {
                    ...
                    if (l == 1 || name.indexOf('l') != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.ML] = int_value;
                    if (l == 1 || name.indexOf('t') != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.MT] = int_value;
                    if (l == 1 || name.indexOf('r') != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.MR] = int_value;
                    if (l == 1 || name.indexOf('b') != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.MB] = int_value;
                } else if (c0 == 'p') {
                    if (l == 1 || name.indexOf('l') != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.PL] = int_value;
                    if (l == 1 || name.indexOf('t') != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.PT] = int_value;
                    if (l == 1 || name.indexOf('r') != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.PR] = int_value;
                    if (l == 1 || name.indexOf('b') != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.PB] = int_value;
                } else if (name.startsWith("bs")) {
                    if (l == 2 || name.indexOf('l', 2) != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.BL] = int_value;
                    if (l == 2 || name.indexOf('t', 2) != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.BT] = int_value;
                    if (l == 2 || name.indexOf('r', 2) != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.BR] = int_value;
                    if (l == 2 || name.indexOf('b', 2) != -1)
                        box.size[net.pierrox.lightning_launcher.data.Box.BB] = int_value;
                    ...
                    for (int n = 0; n < 4; n++) {
                        if (no_border || name.indexOf(border_letters[n], 2) != -1) {
                            ...
                            if (no_mode || name.indexOf('n', 2) != -1)
                                box.border_color[net.pierrox.lightning_launcher.data.Box.COLOR_SHIFT_N + bc] = int_value;
                            if (no_mode || name.indexOf('s', 2) != -1)
                                box.border_color[net.pierrox.lightning_launcher.data.Box.COLOR_SHIFT_S + bc] = int_value;
                            if (no_mode || name.indexOf('f', 2) != -1)
                                box.border_color[net.pierrox.lightning_launcher.data.Box.COLOR_SHIFT_F + bc] = int_value;
                        }
                    }
        ...
        for (net.pierrox.lightning_launcher.data.Item item : page.items) {
            switch (update.getType()) {
                case ITEM:
                    ...
                    break;
                case SHORTCUT:
                    if (item instanceof net.pierrox.lightning_launcher.data.Shortcut && ((net.pierrox.lightning_launcher.data.Shortcut) item).hasSharedShortcutConfig())
                        updateItemView(item, update);
                    break;
                case FOLDER:
                    if (item instanceof net.pierrox.lightning_launcher.data.Folder && ((net.pierrox.lightning_launcher.data.Folder) item).hasSharedFolderConfig())
                        updateItemView(item, update);
                    break;
            }
        }
